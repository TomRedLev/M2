...
public class CompteServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.CompteService {
    ...
    private java.lang.String Compte_address = "http://localhost:8081/Compte/services/Compte";
    ...
    public DefaultNamespace.Compte getCompte(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.CompteSoapBindingStub _stub = new DefaultNamespace.CompteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.Compte.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.CompteSoapBindingStub _stub = new DefaultNamespace.CompteSoapBindingStub(new java.net.URL(Compte_address), this);
                _stub.setPortName(getCompteWSDDServiceName());
                return _stub;
            }
        }
